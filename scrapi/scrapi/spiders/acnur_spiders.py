                    ...
                    for item in descriptions:
                        ...
                        if word_key_in:
                            ...
                            if word_key_not_in:
                                ...
                                code = f"acnur-{descriptions.index(item)}-{datetime.datetime.now()}"

                                tenders_save = Tender(
                                    country_id=item_get_webs.country_id, profile_id=item_profile.id, description=descriptions[descriptions.index(item)], code=code, link=link, dates=dates_save)
                                tenders_save.save()
